...
use paytransferkz\PaymentPage;
use paytransferkz\SignatureHandler;
...
class PaymentPageTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testGetUrl()
    {
        ...
        self::assertEquals(
            'https://paymentpage.paytransfer.kz/payment?project_id=100&interface_type=%7B%22id%22%3A23%7D'
